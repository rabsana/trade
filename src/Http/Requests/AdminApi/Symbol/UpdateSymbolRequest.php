    ...
    public function rules()
    {
        ...
        return [
            'base'                          => array_merge(
                ...
                (array) config('rabsana-trade.updateSymbolAdminApiRequest.base', [])
            ),
            ...
            'quote'                          => array_merge(
                ...
                (array) config('rabsana-trade.updateSymbolAdminApiRequest.quote', [])
            ),
            'pair'                          => "required|max:255|unique:symbols,pair,{$symbolId},id",
