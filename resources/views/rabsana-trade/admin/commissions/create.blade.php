    ...
    <div class='col-lg-12'>
        <div class='card'>
            <div class='card-body'>
                ...
                <form action="{{ route("rabsana-trade.admin-api.v1.commissions.store") }}" method='POST'
                        ...
                        <div class='col-md-12'>
                            <div class='form-group mb-2'>
                                ...
                                <select class='custom-select form-control' id='symbol_quote' name='symbol_quote'
                                    data-value="{{ old("symbol_quote") }}" title="@lang('common.required')"
                        ...
                        <div class='col-md-6'>
                            <div class='form-group mb-2'>
                                ...
                                <input type='text' class='form-control' id='taker_fee' placeholder='fee'
                                    name='taker_fee' value="{{ old('taker_fee') }}" title="@lang('common.required')"
                                    required>
                            </div>
                        </div>
                        ...
                        {{-- <div class='col-md-6'>
                            <div class='form-group mb-2'>
                                ...
                                <input type='text' class='form-control' id='maker_fee' placeholder='maker_fee'
                                    name='maker_fee' value="{{ old('maker_fee') }}" title="@lang('common.required')"
                                    required>
                            </div>
                        </div> --}}
                        ...
                        <div id="conditions">
                            <div class="row">
                                ...
                                <div id="conditionsList">
                                    ...
                                    @foreach (old('conditions') as $key => $item)
                                    @php
                                    $item = (object)$item;
                                    @endphp
                                        ...
                                        <div class='col-md-6'>
                                            <div class='form-group mb-1'>
                                                ...
                                                <input type='text' class='form-control'
                                                    ...
                                                    name='conditions[{{ $key }}][period]' value="{{ $item->period }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class='col-md-6'>
                                            <div class='form-group mb-2'>
                                                ...
                                                <select class='custom-select form-control hasOldProperty'
                                                    ...
                                                    data-placeholder="@lang('common.select')">
                                                </select>
                                            </div>
                                        </div>
