    ...
    <div class='col-lg-12'>
        <div class='card'>
            <div class='card-body'>
                ...
                <form action="{{ route('rabsana-trade.admin-api.v1.symbols.store') }}" method='POST'
                    ...
                    <div class='row p-2'>
                        ...
                        <div class="col-md-12">
                            <div class="alert alert-info">
                                <ul>
                                    ...
                                    <li class="text-danger">
                                        از آنجای که محاسبات صرافی به صورت تومانی می باشد از وارد کردن RIAL,IRR خودداری
                        ...
                        <div class='col-md-4'>
                            <div class='form-group mb-2'>
                                ...
                                <input type='text' class='form-control' id='base' placeholder='BTC,ETH,...' name='base'
                                    value="{{ old('base') }}" title="@lang('trade::rabsana.required')" required>
                            </div>
                        </div>
                        ...
                        <div class='col-md-4'>
                            <div class='form-group mb-2'>
                                ...
                                <input type='text' class='form-control' id='quote' placeholder='USDT,TOMAN,...'
                                    name='quote' value="{{ old('quote') }}" title="@lang('trade::rabsana.required')"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class='col-md-4'>
                            <div class='form-group mb-2'>
                                ...
                                <input type='text' class='form-control' id='pair' placeholder='BTCUSDT,ETHUSDT,...'
                                    name='pair' value="{{ old('pair') }}" title="@lang('trade::rabsana.required')"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class='col-md-4'>
                            <div class='form-group mb-2'>
                                ...
                                <input type='text' class='form-control' id='base_name' placeholder='بیت کوین، اتر, ...'
                                    name='base_name' value="{{ old('base_name') }}"
                        ...
                        <div class='col-md-4'>
                            <div class='form-group mb-2'>
                                ...
                                <input type='text' class='form-control' id='quote_name' placeholder='تتر، تومان، ...'
                                    name='quote_name' value="{{ old('quote_name') }}"
                                    title="@lang('trade::rabsana.required')" required>
                            </div>
                        </div>
                        ...
                        <div class='col-md-4'>
                            <div class='form-group mb-2'>
                                ...
                                <input type='text' class='form-control' id='pair_name' placeholder='بیت کوین / تتر'
                                    name='pair_name' value="{{ old('pair_name') }}"
                                    title="@lang('trade::rabsana.required')" required>
                            </div>
                        </div>
                        ...
                        <div class='col-md-6'>
                            <div class='form-group mb-2'>
                                ...
                                <select class='custom-select form-control' id='buy_is_active' name='buy_is_active'
                                    required>
                                    <option value='1' @if(old('buy_is_active')==1) selected @endif>
                                        @lang('trade::rabsana.active')
                                    </option>
                                    <option value='0' @if(old('buy_is_active')==0) selected @endif>
                        ...
                        <div class='col-md-6'>
                            <div class='form-group mb-2'>
                                ...
                                <select class='custom-select form-control' id='sell_is_active' name='sell_is_active'
                                    required>
                                    <option value='1' @if(old('sell_is_active')==1) selected @endif>
                                        @lang('trade::rabsana.active')
                                    </option>
                                    <option value='0' @if(old('sell_is_active')==0) selected @endif>
                                        @lang('trade::rabsana.inactive')
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class='col-md-4'>
                            <div class='form-group mb-2'>
                                ...
                                <input type='text' class='form-control' id='min_qty' placeholder='min_qty'
                                    name='min_qty' value="{{ old('min_qty') }}" title="@lang('trade::rabsana.required')"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class='col-md-4'>
                            <div class='form-group mb-2'>
                                ...
                                <input type='text' class='form-control' id='max_qty' placeholder='max_qty'
                                    name='max_qty' value="{{ old('max_qty') }}" title="@lang('trade::rabsana.required')"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class='col-md-4'>
                            <div class='form-group mb-2'>
                                ...
                                <input type='text' class='form-control' id='scale_qty' placeholder='scale_qty'
                                    name='scale_qty' value="{{ old('scale_qty') }}"
                                    title="@lang('trade::rabsana.required')" required>
                            </div>
                        </div>
                        ...
                        <div class='col-md-4'>
                            <div class='form-group mb-2'>
                                ...
                                <input type='text' class='form-control' id='scale_price' placeholder='scale_price'
                                    name='scale_price' value="{{ old('scale_price') }}"
                                    title="@lang('trade::rabsana.required')" required>
                            </div>
                        </div>
                        ...
                        <div class='col-md-4'>
                            <div class='form-group mb-2'>
                                ...
                                <input type='text' class='form-control' id='min_notional' placeholder='min_notional'
                                    name='min_notional' value="{{ old('min_notional') }}"
                                    title="@lang('trade::rabsana.required')" required>
                            </div>
                        </div>
                        ...
                        <div class='col-md-4'>
                            <div class='form-group mb-2'>
                                ...
                                <input type='text' class='form-control' id='max_notional' placeholder='max_notional'
                                    name='max_notional' value="{{ old('max_notional') }}"
                                    title="@lang('trade::rabsana.required')" required>
                            </div>
                        </div>
                        ...
                        <div class='col-md-4'>
                            <div class='form-group mb-2'>
                                ...
                                <input type='text' class='form-control' id='scale_notional' placeholder='scale_notional'
                                    name='scale_notional' value="{{ old('scale_notional') }}"
                                    title="@lang('trade::rabsana.required')" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12"">
                            ...
                            <ul>
                                ...
                                <li>
                                    منبع محاسبه میانگین قیمت می تواند سفارشات بازار فعلی یا بازار جهانی مانند بایننس،
                                    کوکوین و ... باشد
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class='col-md-4'>
                        <div class='form-group mb-2'>
                            ...
                            <input type='text' class='form-control' id='percent_order_price_up'
                                ...
                                value="{{ old('percent_order_price_up') }}" title="@lang('trade::rabsana.required')"
                                required>
                        </div>
                    </div>
                    ...
                    <div class='col-md-4'>
                        <div class='form-group mb-2'>
                            ...
                            <input type='text' class='form-control' id='percent_order_price_down'
                                ...
                                value="{{ old('percent_order_price_down') }}" title="@lang('trade::rabsana.required')"
                                required>
                        </div>
                    </div>
                    ...
                    <div class='col-md-4'>
                        <div class='form-group mb-2'>
                            ...
                            <input type='text' class='form-control' id='percent_order_price_minute'
                                ...
                                value="{{ old('percent_order_price_minute') }}" title="@lang('trade::rabsana.required')"
                                required>
                        </div>
                    </div>
                    ...
                    <div class='col-md-6'>
                        <div class='form-group mb-2'>
                            ...
                            <select class='custom-select form-control' id='average_price_source_is_market'
                                ...
                                <option value='1' @if(old('average_price_source_is_market')==1) selected @endif>
                                    بله
                                </option>
                                <option value='0' @if(old('average_price_source_is_market')==0) selected @endif>
                                    خیر
                                </option>
                            </select>
                        </div>
...
<script>
    ...
    var url = '{{ route("rabsana-trade.admin-api.v1.order-types.index") }}';
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            for(var i = 0 ; i < types.length ; i++){
                options += `<option value="${types[i].id}">${types[i].name_translated}</option>`;
            }
            $('#types').html(options);
        }
    });
